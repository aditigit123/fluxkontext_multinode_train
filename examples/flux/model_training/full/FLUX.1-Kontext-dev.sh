accelerate launch --config_file examples/flux/model_training/full/accelerate_config.yaml examples/flux/model_training/train.py \
  --dataset_base_path data/rotation_dataset \
  --dataset_metadata_path data/rotation_dataset/metadata_kontext.csv \
  ...
  --output_path "/mnt/localssd/models/train/FLUX.1-Kontext-dev_full" \
